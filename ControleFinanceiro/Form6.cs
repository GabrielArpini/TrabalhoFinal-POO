...
namespace ControleFinanceiro
{
    public partial class FormConfig : Form
    {
        ...
        {
            var confirmResult = MessageBox.Show("Tem certeza que gostaria de excluir todos os dados?",
                                     "Confirmar Exclusão?",
        ...
        private void btnDeleteAccConfig_Click(object sender, EventArgs e)
        {
            var confirmResult = MessageBox.Show("Tem certeza que gostaria de excluir os dados desta conta?",
                                     "Confirmar Exclusão?",
                                     MessageBoxButtons.YesNo);

            if (confirmResult == DialogResult.Yes)
            {
                var filepath = $"C:\\POOGrupo11Xml\\{lblUsernameMain.Text}.xml";
                ...
                {
                    if (users[i].Username == lblUsernameMain.Text)
                    {                       
                        index = i;break;
                    }
                }
               ...
               // {
                    //if(u.Name == lblUsernameMain.Text)
                    //{
                   //     users.Remover(u);break;
                 //   }
               // }
